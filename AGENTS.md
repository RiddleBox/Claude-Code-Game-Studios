...
At the start of every conversation, read `.Codex/memory/MEMORY.md` to restore project context, design progress, and user preferences. This file is tracked by git and is the authoritative memory source across all machines.

Additional memory files are listed in `.Codex/memory/MEMORY.md`.
